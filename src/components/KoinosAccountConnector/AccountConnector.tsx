...
import { useAccount } from "../KoinosAccountProvider/AccountProvider";
import { CheckIcon, CopyIcon, WarningIcon } from "@chakra-ui/icons";
import { ReactElement, useEffect, useRef } from "react";
import Avatar from "./Avatar";
import SearchBox from "./SearchBox";
import ConnectWallet from "./ConnectWallet";
import { useProfile } from "../KoinosAccountProvider/ProfileProvider";
import { useNameService } from "../KoinosAccountProvider/NameServiceProvider";
import CTA from "./CTA";
            ...
            {address && (
              <>
                <Flex direction="column" alignItems="center" gap="4">
                  ...
                  {names.length > 0 && (
                    <a href="https://kap.domains/account">
